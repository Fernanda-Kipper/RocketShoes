...
Para rodar o app localmente em modo de desenvolvimento você deve:

```
git clone https://github.com/Fernanda-Kipper/RocketShoes.git project_name
cd project_name
npm install
// para rodar o frontend
npm run-script dev
// abra outro terminal de comando para rodar o servidor mock da api
